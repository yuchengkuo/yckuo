    ...
    <LazyMotion features={domAnimation}>
      <m.footer variants={fade} initial="0" animate="1" className="p-16 tablet:px-10 phone:px-5">
        <div className="flex flex-wrap mb-10 justify-between">
          ...
          <p className="font-spectral italic text-base text-gray9 dark:text-gray5">Experiment</p>
        </div>
        <div className="flex flex-wrap pt-10 phone:gap-y-6 border-t border-gray7/20">
          {routes.map((route) => (
            <div key={route.group} className="w-1/4 phone:w-1/2">
              <h4 className="text-gray8 dark:text-gray6 font-apfel text-lg mb-3">{route.group}</h4>
              <ul>
