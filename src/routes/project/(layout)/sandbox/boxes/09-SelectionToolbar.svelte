...
<div
  ...
  children="p-2 rounded bg-surface border-1 border-border transition focus:(outline-none border-fg/50)"
>
  <textarea
    class="resize-none selection-text-bg selection-bg-fg/80"
    rows="3"
    cols="32"
  ...
  />
  <button class="leading-none" hover="bg-fg/10 shadow-sm" active="translate-x-px" on:click={onSend}
...
{#if selectionEnd - selectionStart !== 0}
  <div
    ...
    children="inline-block w-8 h-8 rounded leading-none hover:bg-light-800 dark:hover:bg-dark-100"
    role="menu"
    bind:this={menu}
    out:outro
    use:portal
